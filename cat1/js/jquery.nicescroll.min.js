...
window.msCancelRequestAnimationFrame||!1,y=window.MutationObserver||window.WebKitMutationObserver||!1,E={zindex:"100",cursoropacitymin:0,cursoropacitymax:1,cursorcolor:"#222",cursorwidth:"10px",cursorborder:"1px solid #fff",scrollspeed:60,mousescrollstep:24,touchbehavior:!1,hwacceleration:!0,usetransition:!0,boxzoom:!1,dblclickzoom:!0,gesturezoom:!0,grabcursorenabled:!0,autohidemode:!0,background:"",iframeautoresize:!0,cursorminheight:32,preservenativescrolling:!0,railoffset:!1,
...
c.hborder=parseFloat(c.outerHeight()-c.innerHeight());b.cursor=c;var f=e(document.createElement("div"));f.attr("id",b.id);f.addClass("nicescroll-rails");var l,k,m=["left","right"],F;for(F in m)k=m[F],(l=b.opt.railpadding[k])?f.css("padding-"+k,l+"px"):b.opt.railpadding[k]=0;f.append(c);f.width=Math.max(parseFloat(b.opt.cursorwidth),c.outerWidth())+b.opt.railpadding.left+b.opt.railpadding.right;f.css({width:f.width+"px",zIndex:b.zindex,background:b.opt.background});f.visibility=!0;
